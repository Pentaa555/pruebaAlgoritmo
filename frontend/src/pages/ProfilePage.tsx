...
export function ProfilePage() {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '500px' }}>
      <h1 style={{ color: '#1e3a8a', marginBottom: '0.25rem' }}>Mi perfil</h1>
      <p style={{ color: '#6b7280', marginBottom: '1.5rem' }}>{user?.email}</p>

      {success && <div role="status" style={{ background: '#f0fdf4', color: '#166534', padding: '0.75rem', borderRadius: '4px', marginBottom: '1rem', fontSize: '14px' }}>Perfil actualizado.</div>}
